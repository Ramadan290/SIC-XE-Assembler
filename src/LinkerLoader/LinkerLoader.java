...
public class LinkerLoader {
    public static Integer CSlength = 1000;
    ...
    public static void Pass1(ExternalSymbolTable externalSymbolTable, String instruction){
        if(instruction.charAt(0) == 'H'){
            ...
            CSlength = Integer.parseInt(instruction.substring(11, 17), 16);
            ...
            if(instruction.length() > 1) {
                ...
                Main.executionAddress = Main.startMemory + Integer.parseInt(executionAddress, 16);
            }
    ...
    public static Integer CSStartAddress = 1000;
    ...
    public static void Pass2(ExternalSymbolTable externalSymbolTable, ArrayList<String> memoryMap, String instruction){
        if(instruction.charAt(0) == 'H'){
            ...
            CSlabel = CSlabel.replaceAll(" ", "");
            CSStartAddress = externalSymbolTable.CSList.get(CSlabel)[0] - Main.startMemory;
        }
