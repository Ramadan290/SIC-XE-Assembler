...
/**
 * This whole class just converts String to integer or integer to String in order to create TRecord
 * it is only used as a Method in other parts of the program
 */
class TRecordList {
    private int count = 0;
